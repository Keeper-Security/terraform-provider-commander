...
page_title: "commander_pam_machine Resource - commander"
subcategory: ""
description: |-
...
# commander_pam_machine (Resource)
...
- `administrative_credentials` (String) Whether **administrative credentials** are enabled for the PAM record.
