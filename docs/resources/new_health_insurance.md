...
page_title: "commander_new_health_insurance Resource - commander"
subcategory: "New (NSF) Records"
description: |-
  Creates and manages a New (NSF) Health Insurance record in the vault.
---

# commander_new_health_insurance (Resource)
