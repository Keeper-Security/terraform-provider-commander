...
page_title: "commander_classic_health_insurance Data Source - commander"
subcategory: "Classic Records"
description: |-
  Use this data source to look up a Keeper healthInsurance (Health Insurance) record by title or UID.
---

# commander_classic_health_insurance (Data Source)
...
- `health_insurance` (String) Health Insurance record **title** or **UID** to look up.
