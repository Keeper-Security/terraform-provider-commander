...
// SharedAttributes returns the SSN Card (Identity Card) resource attribute map shared
// between classic and new resources. Callers add any share-extension attribute separately.
...
// SharedDataSourceAttributes returns computed SSN Card (Identity Card) data source
// attributes shared between classic and new data sources. Callers add the lookup key
// (e.g. ssn_card) and share-extension attributes separately.
