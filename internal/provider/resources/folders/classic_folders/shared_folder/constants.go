...
const (
	...
	DescUsers                  = "Per-user permissions. Map key is User Email/UID or Team Name/UID; value is an object with manage_users and manage_records. The owner is implicit and never present in this map; the API rejects owner entries."
	DescUsersMD                = "Per-user permissions. Map key is User Email/UID or Team Name/UID; value is an object with `manage_users`, `manage_records`. The owner is implicit and never present in this map; the API rejects owner entries."
