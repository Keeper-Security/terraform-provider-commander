...
const (
	...
	DescUsers                  = "Per-user permissions. Map key is User Email/UID or Team Name/UID; value is an object with manage_users, manage_records, "
	DescUsersMD                = "Per-user permissions. Map key is User Email/UID or Team Name/UID; value is an object with `manage_users`, `manage_records`."
