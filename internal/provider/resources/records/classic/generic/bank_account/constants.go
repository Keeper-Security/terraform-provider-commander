...
const (
	SchemaDescription         = "Creates and manages a Bank Account record in the vault."
	SchemaMarkdownDescription = "Creates and manages a **Bank Account** record in the vault."
