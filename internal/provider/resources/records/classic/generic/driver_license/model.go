...
// DriverLicenseResourceModel is the classic driver's license resource state model:
// shared driver's license fields plus the `share` attribute reconciled via classic_share.
