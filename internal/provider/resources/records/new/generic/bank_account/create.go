...
func (r *BankAccountResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data BankAccountResourceModel
	...
	cmd := commonrecordbankaccount.BuildAddCommand(utils.CmdNsfRecordAdd, data.BankAccountModel)
