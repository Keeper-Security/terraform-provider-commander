...
func (r *SecureNoteResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data SecureNoteResourceModel
	...
	cmd := commonrecordsecurenote.BuildAddCommand(utils.CmdNsfRecordAdd, data.SecureNoteModel)
