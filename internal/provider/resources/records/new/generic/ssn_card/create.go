...
func (r *SsnCardResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data SsnCardResourceModel
	...
	cmd := commonrecordssncard.BuildAddCommand(utils.CmdNsfRecordAdd, data.SsnCardModel)
