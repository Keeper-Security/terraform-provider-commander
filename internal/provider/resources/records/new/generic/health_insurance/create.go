...
func (r *HealthInsuranceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data HealthInsuranceResourceModel
	...
	cmd := commonrecordhealthinsurance.BuildAddCommand(utils.CmdNsfRecordAdd, data.HealthInsuranceModel)
