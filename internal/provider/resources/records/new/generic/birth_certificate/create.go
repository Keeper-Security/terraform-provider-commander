...
func (r *BirthCertificateResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data BirthCertificateResourceModel
	...
	cmd := commonrecordbirthcertificate.BuildAddCommand(utils.CmdNsfRecordAdd, data.BirthCertificateModel)
