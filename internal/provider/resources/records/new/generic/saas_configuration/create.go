...
func (r *SaasConfigurationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data SaasConfigurationResourceModel
	...
	cmd := commonrecordsaasconfiguration.BuildAddCommand(utils.CmdNsfRecordAdd, data.SaasConfigurationModel)
