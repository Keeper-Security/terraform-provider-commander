...
func (r *PaymentCardResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data PaymentCardResourceModel
	...
	cmd := commonrecordpaymentcard.BuildAddCommand(utils.CmdNsfRecordAdd, data.PaymentCardModel)
