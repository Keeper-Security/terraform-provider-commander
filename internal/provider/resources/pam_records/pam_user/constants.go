...
const (
	...
	RotScheduleCronDescription           = "Cron schedule for rotation (e.g. \"56 17 * * *\")."
	RotScheduleCronMarkdownDescription   = "Cron schedule for rotation (e.g. `56 17 * * *`)."
	...
	RotComplexityDescription             = "Password complexity for rotation (e.g. \"20,4,4,4,4\")."
	RotComplexityMarkdownDescription     = "Password complexity for rotation (e.g. `20,4,4,4,4` for length,upper,lower,digits,symbols)."
