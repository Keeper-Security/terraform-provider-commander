...
# ------------------------------------------------------------------
resource "commander_classic_pam_directory" "minimal" {
...
# ------------------------------------------------------------------
resource "commander_classic_pam_directory" "active_directory" {
  title = "PAM Directory - corp-dc-01"
...
# ------------------------------------------------------------------
resource "commander_classic_pam_directory" "openldap" {
...
# ------------------------------------------------------------------
resource "commander_classic_pam_directory" "full" {
...
# ------------------------------------------------------------------
resource "commander_classic_pam_directory" "tunnel_only" {
