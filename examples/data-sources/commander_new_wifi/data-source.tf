###############################################################################
# Usage 1 - Look up a New (NSF) WiFi record by record UID
###############################################################################

data "commander_new_wifi" "office_guest" {
...
# data "commander_new_wifi" "from_managed_resource" {
#   wifi = commander_new_wifi.home.id
# }
...
output "wifi_id" {
  ...
  value       = data.commander_new_wifi.office_guest.id
}

output "wifi_title" {
  value = data.commander_new_wifi.office_guest.title
}

output "wifi_ssid" {
  description = "WiFi network name (SSID)."
  value       = data.commander_new_wifi.office_guest.ssid
}

output "wifi_encryption" {
  description = "Encryption type: wep | wpa | noEncryption."
  value       = data.commander_new_wifi.office_guest.encryption
}

output "wifi_is_ssid_hidden" {
  value = data.commander_new_wifi.office_guest.is_ssid_hidden
}

output "wifi_folder_location" {
  value = data.commander_new_wifi.office_guest.folder_location
}

output "wifi_notes" {
  value = data.commander_new_wifi.office_guest.notes
}
...
output "wifi_password" {
  ...
  value       = data.commander_new_wifi.office_guest.password
  sensitive   = true
}
...
output "wifi_custom" {
  ...
  value       = data.commander_new_wifi.office_guest.custom
  sensitive   = true
}
...
output "wifi_share" {
  ...
  value       = data.commander_new_wifi.office_guest.share
}
