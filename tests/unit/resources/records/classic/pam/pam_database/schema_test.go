...
func TestPamDatabaseResource_Schema(t *testing.T) {
...
func TestPamDatabaseResource_SchemaHostnameOrIPBlock(t *testing.T) {
	r := pamdatabase.NewPamDatabaseResource().(*pamdatabase.PamDatabaseResource)
	var resp resource.SchemaResponse
...
func TestPamDatabaseResource_SchemaPamSettingsBlock(t *testing.T) {
	r := pamdatabase.NewPamDatabaseResource().(*pamdatabase.PamDatabaseResource)
	var resp resource.SchemaResponse
	r.Schema(context.Background(), resource.SchemaRequest{}, &resp)
