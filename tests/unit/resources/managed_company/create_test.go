...
func TestManagedCompanyResource_Create_Success(t *testing.T) {
...
func TestManagedCompanyResource_Create_WithOptionalFields(t *testing.T) {
	mock := &helpers.CommandServer{}
	responseForCommand := func(cmd string, idx int) (string, interface{}) {
...
func TestManagedCompanyResource_Create_ApiError(t *testing.T) {
...
func TestManagedCompanyResource_Create_NoApiManager(t *testing.T) {
