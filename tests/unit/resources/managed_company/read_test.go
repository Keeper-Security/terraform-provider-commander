...
// ManagedCompanyResponse: company_id, company_name, node, node_name, plan, storage, addons, allocated.
...
func TestManagedCompanyResource_Read_Success(t *testing.T) {
...
func TestManagedCompanyResource_Read_NotFound(t *testing.T) {
	mock := &helpers.CommandServer{}
	responseForCommand := func(cmd string, idx int) (string, interface{}) {
		if strings.Contains(cmd, "msp-down") {
			return "ok", nil
...
func TestManagedCompanyResource_Read_NoApiManager(t *testing.T) {
...
func TestManagedCompanyResource_Read_ApiError(t *testing.T) {
