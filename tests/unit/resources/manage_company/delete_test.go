...
func TestManageCompanyResource_Delete_Success(t *testing.T) {
...
func TestManageCompanyResource_Delete_NoApiManager(t *testing.T) {
...
func TestManageCompanyResource_Delete_ApiError(t *testing.T) {
...
func TestManageCompanyResource_Delete_StateGetError(t *testing.T) {
	r := managecompany.NewManageCompanyResource().(*managecompany.ManageCompanyResource)
