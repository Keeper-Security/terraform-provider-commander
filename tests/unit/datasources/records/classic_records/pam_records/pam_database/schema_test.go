...
import (
	...
	pamdatabase "github.com/Keeper-Security/terraform-provider-commander/internal/provider/datasources/records/classic_records/pam_records/pam_database"
	"github.com/hashicorp/terraform-plugin-framework/datasource"
	dschema "github.com/hashicorp/terraform-plugin-framework/datasource/schema"
)

func TestPamDatabaseDataSource_Schema(t *testing.T) {
...
func TestPamDatabaseDataSource_SchemaHostnameOrIPNested(t *testing.T) {
	d := pamdatabase.NewPamDatabaseDataSource().(*pamdatabase.PamDatabaseDataSource)
	var resp datasource.SchemaResponse
...
func TestPamDatabaseDataSource_SchemaPamSettingsNested(t *testing.T) {
	d := pamdatabase.NewPamDatabaseDataSource().(*pamdatabase.PamDatabaseDataSource)
	var resp datasource.SchemaResponse
	d.Schema(context.Background(), datasource.SchemaRequest{}, &resp)
