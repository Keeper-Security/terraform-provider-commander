...
func TestManagedCompanyDataSource_Read_Success(t *testing.T) {
...
func TestManagedCompanyDataSource_Read_ById(t *testing.T) {
	mock := &helpers.CommandServer{}
	responseForCommand := func(cmd string, idx int) (string, interface{}) {
...
func TestManagedCompanyDataSource_Read_NotFound(t *testing.T) {
	mock := &helpers.CommandServer{}
	responseForCommand := func(cmd string, idx int) (string, interface{}) {
		if cmd == "msp-down" {
			return "ok", nil
...
func TestManagedCompanyDataSource_Read_NoApiManager(t *testing.T) {
...
func TestManagedCompanyDataSource_Read_ApiError(t *testing.T) {
