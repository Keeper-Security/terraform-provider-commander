...
- **Keeper Commander Service Mode**: A service account running latest version of Commander Service Mode REST API. Make sure you are running **Commander version 18.0.9** or **later** before starting Service Mode
